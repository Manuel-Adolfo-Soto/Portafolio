...
.title{font-size:14pt;font-weight:600;color:#059669;margin-bottom:2px}
...
.sep{width:100%;height:2px;background:linear-gradient(90deg,#10b981,#14b8a6);margin:14px 0 18px;border:0}
.section{margin-bottom:22px}
.section-title{font-size:9pt;font-weight:700;text-transform:uppercase;letter-spacing:.15em;color:#059669;border-bottom:2px solid #e2e8f0;padding-bottom:6px;margin-bottom:12px}
...
.exp-company{font-size:9pt;font-weight:500;color:#059669}
...
.skills-title{font-size:8pt;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#059669;margin-bottom:2px}
...
.proj-role{font-size:8pt;font-weight:500;color:#059669}
...
.edu-inst{font-size:9pt;color:#059669}
...
.cert-issuer{font-size:8pt;color:#059669}
...
.toolbar button{padding:10px 28px;background:linear-gradient(135deg,#10b981,#14b8a6);color:#fff;border:none;border-radius:8px;font-size:15px;font-weight:600;cursor:pointer}
...
<img src="${location.origin}/images/Mi%20foto%20de%20perfil/Mi%20foto%20de%20perfil.jpeg" alt="${data.name}" style="width:120px;height:120px;border-radius:50%;object-fit:cover;border:2px solid rgba(16,185,129,0.3)">
</div>
<div>
<h1>${data.name}</h1>
