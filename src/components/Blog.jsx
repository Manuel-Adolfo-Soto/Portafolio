  ...
  return (
    <section id="blog" className="relative py-16 px-4 overflow-hidden">
      ...
      >
        ...
        >
          <div className="glass rounded-xl overflow-hidden card-hover border border-slate-200/50 dark:border-slate-700/50">
            ...
            <div className="p-6 md:p-8">
              ...
              <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-6">{post.intro}</p>
              ...
              <div className="bg-white/80 dark:bg-slate-900/80 rounded-xl p-4 mb-6 overflow-x-auto border border-slate-200 dark:border-slate-800">
                <pre className="text-xs font-mono text-slate-600 dark:text-slate-300 leading-relaxed whitespace-pre">{codeSnippet}</pre>
              </div>

              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-6">{post.conclusion}</p>
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <div className="glass rounded-xl p-6 text-center border border-dashed border-slate-200/50 dark:border-slate-700/50">
            <p className="text-slate-400 dark:text-slate-500 text-sm font-mono">{t('blog.nextPost')}</p>
          </div>
        </motion.div>
      </motion.div>
    </section>
