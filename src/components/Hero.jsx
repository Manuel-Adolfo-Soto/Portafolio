  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Description */}
        <motion.p variants={itemVariants} className="text-base sm:text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto mb-6 leading-relaxed">
          {t('hero.description')}
        </motion.p>
        ...
        <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="me noopener noreferrer"
            className="group relative px-8 py-3.5 bg-slate-100 dark:bg-slate-800/80 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-semibold rounded-xl overflow-hidden transition-all duration-300 hover:border-teal-500/50 hover:bg-slate-700/80 hover:scale-105 backdrop-blur-sm"
          >
            <span className="flex items-center gap-2">
        ...
        <motion.div variants={itemVariants} className="mt-16">
          <p className="text-xs text-slate-400 dark:text-slate-600 mb-3 font-mono tracking-widest uppercase">{t('hero.mainStack')}</p>
          <div className="flex justify-center gap-6 flex-wrap">
            {['Angular', 'NestJS', 'TypeScript', 'PostgreSQL', 'Docker'].map((tech) => (
              <span key={tech} className="text-sm text-slate-400 dark:text-slate-500 hover:text-emerald-400 transition-colors font-mono">
                {tech}
              </span>
            ))}
          </div>
