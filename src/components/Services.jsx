    ...
    <section className="relative py-16 px-4 overflow-hidden">
      ...
      >
        <motion.div variants={item}>
          ...
          <p className="text-gray-500 dark:text-gray-400 max-w-2xl mb-12">{t('services.subtitle')}</p>
        </motion.div>
            ...
            <motion.div key={i} variants={item}>
              <div className="glass rounded-xl p-6 card-hover h-full group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-gray-900 dark:text-white font-semibold mb-1">{service.title}</h3>
        ...
        <motion.div variants={item} className="mt-10 text-center">
          <div className="inline-flex items-center gap-2 px-6 py-3 text-sm text-gray-400 dark:text-gray-500 bg-gray-100/50 dark:bg-gray-800/30 rounded-xl border border-gray-200/30 dark:border-gray-700/30">
