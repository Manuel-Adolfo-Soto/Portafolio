...
export default function CinematicSplash({ isVisible, onFinish, onSkip }) {
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed inset-0 z-[200] bg-slate-950 overflow-hidden cursor-pointer"
          onClick={onSkip}
        >
          <div className="absolute top-6 right-6 z-30 text-xs text-slate-600 font-mono tracking-wider">
            Click to skip
          </div>
          {/* 3D Scene */}
